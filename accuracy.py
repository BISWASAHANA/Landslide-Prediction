...
plt.savefig("accuracy_confusion_matrix.png")  # Save confusion matrix as an image
plt.show()

print("Evaluation completed! Results saved to 'e_r_.txt' and 'accuracy_confusion_matrix.png'")
